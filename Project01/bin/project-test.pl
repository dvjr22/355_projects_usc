...
$test_suite_root = "/home/valdeslab/Downloads/Project01/test-suite"; # $test_suite_root = "$ENV{HOME}/public_html/csce355/prog-proj/test-suite";

# directory holding the executables used in testing
$bin_dir = "/home/valdeslab/Downloads/Project01/bin"; # $bin_dir = "$ENV{HOME}/public_html/csce355/prog-proj/bin";
